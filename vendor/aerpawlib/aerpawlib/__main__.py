...
from .runner import BasicRunner, Runner, StateMachine, ZmqStateMachine
...
if __name__ == "__main__":
    ...
    parser.add_argument("--skip-init", help="skip initialization", required=False, const=False, default=True, action="store_const", dest="initialize")
    parser.add_argument("--run-proxy", help="run zmq proxy", required=False, const=True, default=False, action="store_const", dest="run_zmq_proxy")
    ...
    parser.add_argument("--skip-rtl", help="don't rtl and land at the end of an experiment automatically", const=False, default=True, action="store_const", dest="rtl_at_end")
    parser.add_argument("--debug-dump", help="run aerpawlib's internal debug dump on vehicle object", required=False, const=True, default=False, action="store_const", dest="debug_dump")
    parser.add_argument("--no-aerpawlib-stdout", help="prevent aerpawlib from printing to stdout", required=False, const=True, default=False, action="store_const", dest="no_stdout")
    ...
    vehicle_type = {"generic": Vehicle, "drone": Drone, "rover": Rover, "none": DummyVehicle}.get(args.vehicle, None)
