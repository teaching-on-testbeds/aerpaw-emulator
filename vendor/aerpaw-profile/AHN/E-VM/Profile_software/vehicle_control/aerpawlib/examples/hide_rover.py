...
from aerpawlib.util import Coordinate, inside, read_from_plan_complete, readGeofence
...
class HideRover(StateMachine):
    ...
    async def hide_rover(self, vehicle: Vehicle):
        ...
        await vehicle.goto_coordinates(hide_coords, target_heading=self._default_heading)
        print("done!")
        return None
