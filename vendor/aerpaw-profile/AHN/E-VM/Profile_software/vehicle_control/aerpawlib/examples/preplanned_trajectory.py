...
class PreplannedTrajectory(StateMachine):
    ...
    async def initialize_flight(self, vehicle: Vehicle):
        ...
        for waypoint in self._waypoints[1:]:
            ...
            new_cmd = dk.Command(0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 0, 0, 0, 0, wp_coord.lat, wp_coord.lon, wp_coord.alt)
