...
#
log_file="Iperf_clienti_UL_log_$(date +"%Y_%m_%d_%H\:%M\:%S").log"
...
#bash -c "stdbuf -oL -eL iperf3 -c $2 -t $IPERF_DURATION -B $1 | tee log/$log_file"
bash -c "stdbuf -oL -eL iperf3 -c $2 -t $IPERF_DURATION | tee log/$log_file"
